...
public enum ErrorCode {
    ...
    INVALID_MEMBER_ID(BAD_REQUEST, "회원 pk 입력 형식이 올바르지 않습니다!"),
    ...
    INVALID_MEMBER_NICKNAME_STATUS(BAD_REQUEST, "이미 닉네임이 등록된 회원입니다!"),
    ...
    INVALID_DIARY_ID(BAD_REQUEST, "일기 pk 입력 형식이 올바르지 않습니다!"),
    INVALID_DIARY_EMOTION_ID(BAD_REQUEST, "감정 pk 입력 형식이 올바르지 않습니다!"),
    ...
    INVALID_BACKGROUND_MUSIC_ID(BAD_REQUEST, "배경음악 pk 입력 형식이 올바르지 않습니다!"),
