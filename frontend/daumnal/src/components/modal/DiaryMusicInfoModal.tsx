...
const DiaryMusicInfoModal: React.FC<DiaryMusicInfoModalProps> = ({ selectedMusicId }) => {
  // 플레이리스트 생성 모달 상태 변수
      ...
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        {isOpenCreateModal && (
          <CreatePlaylistModalContainer>
            <DiaryCreatePlaylistModal onClickToggleModal={handleCreatePlaylist} />
          </CreatePlaylistModalContainer>
        )}
        {/* 새 플레이리스트 생성 모달 버튼 */}
...
export default DiaryMusicInfoModal;