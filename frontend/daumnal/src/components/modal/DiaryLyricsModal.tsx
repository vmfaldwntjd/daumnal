...
const DiaryLyricsModal: React.FC<DiaryLyricsModalProps> = ({ onClickToggleModal, diaryMusicLyrics }) => {
  ...
  return (
    <div className='fixed mr-[134px] inset-0 bg-white bg-opacity-0 flex justify-center items-center'> {/* 배경 클릭 시 모달 닫기 */}
      <div onClick={(e) => e.stopPropagation()} className='w-[400px] h-[80%] m-auto  shadow-lg bg-white rounded-sm'> {/* 모달 컨텐츠 클릭 시 버블링 방지 */}
        ...
        <div className='h-[90%] overflow-y-auto flex flex-col items-center text-[#776B5D] font-[20px]'>
            {/* 가사 */}
