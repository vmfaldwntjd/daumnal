...
interface DiaryCreatePlaylistModalProps {
...
const DiaryCreatePlaylistModal: React.FC<DiaryCreatePlaylistModalProps> = ({ onClickToggleModal }) => {
  // 플레이리스트 제목 상태
  ...
  return (
    <div onClick={onClickToggleModal} className='fixed mr-[134px] inset-0 bg-black bg-opacity-40 flex justify-center items-center'>
...
export default DiaryCreatePlaylistModal;